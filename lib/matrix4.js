...
export class Matrix4 {
    ...
    /**
     * Constructor
     * @param {Matrix4, Array, Float32Array} [src] the source of elements
     */
    constructor(src) {
        if (src) {
    ...
    /**
     * Set scaling matrix
     * @param {Number} x the scaling along x axis
     * @param {Number} y the scaling along y axis
     * @param {Number} z the scaling along z axis
     * @return {Matrix4} this
     */
    setScale(x, y, z) {
        let e = this.elements;
     ...
     * @param {Number} x the translation along x axis
     * @param {Number} y the translation along y axis
     * @param {Number} z the translation along z axis
     * @return {Matrix4} this
     */
    setTranslate(x, y, z) {
        let e = this.elements;
     ...
     * @param {Number} x the x component of rotation axis
     * @param {Number} y the y component of rotation axis
     * @param {Number} z the z component of rotation axis
     * @return {Matrix4} this
     */
    ...
    /**
     * Set view matrix
     * @param {Number} eyeX the x component of eye point
     * @param {Number} eyeY the y component of eye point
     * @param {Number} eyeZ the z component of eye point
     * @param {Number} centerX the x component of reference point
     * @param {Number} centerY the y component of reference point
     * @param {Number} centerZ the z component of reference point
     * @param {Number} upX the x component of up vector
     * @param {Number} upY the y component of up vector
     * @param {Number} upZ the z component of up vector
     * @return {Matrix4} this
     */
    ...
    /**
     * Multiply matrix by view matrix
     * @param {Number} eyeX the x component of eye point
     * @param {Number} eyeY the y component of eye point
     * @param {Number} eyeZ the z component of eye point
     * @param {Number} centerX the x component of reference point
     ...
     * @param {Number} left the coordinate of left clipping plane
     * @param {Number} right the coordinate of right clipping plane
     * @param {Number} bottom the coordinate of bottom clipping plane
     * @param {Number} top the coordinate of top clipping plane
     * @param {Number} near the distance to near clipping plane (negative if plane is behind view point)
     * @param {Number} far the distance to far clipping plane (negative if plane is behind view point)
     * @return {Matrix4} this
     */
    setOrthogonal(left, right, bottom, top, near, far) {
        if (left === right || bottom === top || near === far) throw `Matrix4.setOrthogonal: clip space has a zero volume`;
    ...
    /**
     * Multiply matrix by orthogonal projection matrix
     * @param {Number} left the coordinate of left clipping plane
     * @param {Number} right the coordinate of right clipping plane
     * @param {Number} bottom the coordinate of bottom clipping plane
     * @param {Number} top the coordinate of top clipping plane
     ...
     * @param {Number} left the coordinate of left side of near clipping plane
     * @param {Number} right the coordinate of right side of near clipping plane
     * @param {Number} bottom the coordinate of bottom side of near clipping plane
     * @param {Number} top the coordinate of top side of near clipping plane
     * @param {Number} near the distance to near clipping plane (positive)
     * @param {Number} far the distance to far clipping plane (positive)
     * @return {Matrix4} this
     */
    setFrustum(left, right, bottom, top, near, far) {
        if (left === right || top === bottom || near === far) throw `Matrix4.setFrustum: clip space has a zero volume`;
    ...
    /**
     * Multiply matrix by frustum projection matrix
     * @param {Number} left the coordinate of left side of near clipping plane
     * @param {Number} right the coordinate of right side of near clipping plane
     * @param {Number} bottom the coordinate of bottom side of near clipping plane
     * @param {Number} top the coordinate of top side of near clipping plane
     ...
     * @param {Number} fovY the field of view in vertical plane in degrees
     * @param {Number} aspect the aspect of near and far clipping planes
     * @param {Number} near the distance to near clipping plane (positive)
     * @param {Number} far the distance to far clipping plane (positive)
     * @return {Matrix4} this
     */
    setPerspective(fovY, aspect, near, far) {
        if (near === far || aspect === 0) throw `Matrix4.setPerspective: clip space has a zero volume`;
        ...
        let s = Math.sin(fovY);
        if (s === 0) throw `Matrix4.setPerspective: clip space has a zero volume`;
    ...
    /**
     * Multiply matrix by perspective projection matrix
     * @param {Number} fovY the field of view in vertical plane in degrees
     * @param {Number} aspect the aspect of near and far clipping planes
     * @param {Number} near the distance to near clipping plane (positive)
     * @param {Number} far the distance to far clipping plane (positive)
